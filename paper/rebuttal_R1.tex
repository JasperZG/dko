...
\textbf{Specific changes:}
\begin{itemize}[itemsep=2pt]
    \item Scaffold split procedure details: \lines{281}
    \item Replicate counts explicitly stated: \lines{281}
    \item Stratified splits for classification explained: \lines{471}
\end{itemize}
